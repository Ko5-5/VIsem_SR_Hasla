...
#define USBD_PRODUCT_STRING_FS     "STM32 Keyboard Device"
...
USBD_DescriptorsTypeDef FS_Desc_SETUP =
{
		USBD_FS_DeviceDescriptor_SETUP
		, USBD_FS_LangIDStrDescriptor
		, USBD_FS_ManufacturerStrDescriptor
		, USBD_FS_ProductStrDescriptor
		, USBD_FS_SerialStrDescriptor
...
// wpisywanie hasel descriptor
__ALIGN_BEGIN uint8_t USBD_FS_DeviceDesc_SETUP[USB_LEN_DEV_DESC] __ALIGN_END =
{
		0x12,                       /*bLength */
		USB_DESC_TYPE_DEVICE,       /*bDescriptorType*/
#if (USBD_LPM_ENABLED == 1)
