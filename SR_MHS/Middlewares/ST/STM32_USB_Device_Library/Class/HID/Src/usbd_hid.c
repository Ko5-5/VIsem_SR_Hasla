...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END = {
		...
		0x01,                                               /* nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse */							//MADE FOR KEYBOARD
...
__ALIGN_BEGIN static uint8_t HID_MOUSE_ReportDesc[HID_MOUSE_REPORT_DESC_SIZE] __ALIGN_END = { 								// MADE FOR KEYBOARD
