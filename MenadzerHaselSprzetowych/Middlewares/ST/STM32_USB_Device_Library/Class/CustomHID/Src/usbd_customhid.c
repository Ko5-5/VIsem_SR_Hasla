...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgFSDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
		...
		0x01,                                               /* nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse */ 										//CHANGED TO KEYBOARD
...
__ALIGN_BEGIN static uint8_t HID_KEYBOARD_ReportDesc[63U/*HID_KEYBOARD_REPORT_DESC_SIZE*/] __ALIGN_END =
{
